...
<link rel="stylesheet" type="text/css" href="<c:url value='/css/theme.css'/>?v=20260613-ds6">
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/onboarding.css?v=20260613-ds6">
