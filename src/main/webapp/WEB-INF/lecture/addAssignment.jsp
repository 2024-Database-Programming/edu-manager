...
<link rel="stylesheet" href="<c:url value='/css/addSchedule.css' />?v=20260620-wide1" />
</head>
<body>
	<div class="main-container">
		<div style="width: 90%; justify-self: center;"><jsp:include
				page="../navigation/navigation.jsp" /></div>
		<form action="<c:url value='/lecture/addAssignment' />" method="POST" enctype="multipart/form-data">
